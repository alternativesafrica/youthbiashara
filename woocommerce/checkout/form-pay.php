	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'youthafrica' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'youthafrica' ); ?></th>
			</tr>
		</thead>
		<tbody>
